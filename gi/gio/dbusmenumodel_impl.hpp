...
Gio::DBusMenuModel base::DBusMenuModelBase::get (Gio::DBusConnection connection, const gi::cstring_v bus_name, const gi::cstring_v object_path) noexcept
{
...
Gio::DBusMenuModel base::DBusMenuModelBase::get (Gio::DBusConnection connection, const gi::cstring_v object_path) noexcept
{
  typedef ::GDBusMenuModel* (*call_wrap_t) (::GDBusConnection* connection, const char* bus_name, const char* object_path);
  call_wrap_t call_wrap_v = (call_wrap_t) ::g_dbus_menu_model_get;
  auto object_path_to_c = gi::unwrap (object_path, gi::transfer_none);
